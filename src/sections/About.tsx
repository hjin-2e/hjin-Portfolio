        ...
        <div className="about-wrap">
          <div className="about-box container-md">
            ...
            <div className="about-txt">
              <p>안녕하세요. 사용자 경험부터 클라우드 인프라까지 연결하는 클라우드 엔지니어 이하진입니다.</p>
              <p>웹 퍼블리셔로 서비스를 개발하며 사용자와 가장 가까운 영역을 경험했습니다.</p>
              <p>이후 서비스가 안정적으로 운영되고 빠르게 배포되는 환경의 중요성을 깨닫고 클라우드 엔지니어의 길을 선택했습니다.</p>
              <p>저는 단순히 인프라를 구축하는 데 그치지 않고, 클라이언트와 개발팀의 요구사항을 이해하여 효율적인 CI/CD 환경을 설계하고, IaC를 통해 반복적인 작업을 자동화하여 생산성을 높이는 것에 가치를 두고 있습니다.</p>
              <p>프론트엔드부터 인프라까지 서비스 전반을 바라보는 시각을 바탕으로, 팀과 적극적으로 소통하며 안정적인 서비스 운영과 지속적인 개선을 만들어가는 클라우드 엔지니어가 되겠습니다.</p>
